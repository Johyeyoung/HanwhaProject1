...
class DealView(SubviewContainerMixin, ModelView):
    ...
    column_list = ("inisCdHref", "inisNm", "inisType", 'insIdHref', "posType", 'matDt', 'atmCd', 'strike', 'status', 'baseDt')
    column_labels = {"inisCdHref": '종목코드', "inisNm": '종목명', "inisType": "타입",
                     'insIdHref': '기초자산ID', 'posType': 'Pos', 'matDt': '만기일자',
                     'atmCd': 'ATM코드', 'strike': '행사가격', 'status': '딜상태', 'baseDt': '입수일자'
                     }
