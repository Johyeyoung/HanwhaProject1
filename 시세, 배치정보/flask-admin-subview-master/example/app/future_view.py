...
class FutureView(SubviewContainerMixin, ModelView):
    ...
    column_sortable_list = ("inisType", 'insId', 'matDt',  'status', 'baseDt')
    column_filters = ("inisType", "inisCd", 'insId', 'matDt',  'baseDt')

    column_formatters = {
        # a href 관련 칼럼 생성
        "inisCdHref": model_link_formatter_inisCd(section="future", attr=""),
        "insIdHref": model_link_formatter_insId(section="underlying", attr=""),
    }
    column_list = ("inisCdHref", "inisNm", "inisType", 'insIdHref', 'matDt', 'status', 'baseDt')
    column_labels = {"inisCdHref": '종목코드', "inisNm": '종목명', "inisType": "타입",
                     'insIdHref': '기초자산ID','matDt': '만기일자',
                      'status': '딜상태', 'baseDt': '생성일자'
                     }
    ...
    def details_view(self):
        ...
        template = "admin/model/details_with_futureSubview.html"
